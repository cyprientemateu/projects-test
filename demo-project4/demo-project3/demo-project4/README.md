# Dynamic Resume Deployment (Flask + Nginx + EC2 + Terraform + Ansible)
This project hosts a dynamic, interactive resume website built using Flask (Python).
It includes multiple pages (Home, About, Projects, Contact), static styling, and dark-mode support.

The application can be deployed on an AWS EC2 instance, using Nginx as a reverse proxy for production hosting.
### Steps:
